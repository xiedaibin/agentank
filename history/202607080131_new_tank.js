/**
 * AgenTank AI Agent - XDB (Strategic Assassin V13.20 - Performance Pruning)
 * V13.20: 在 findNearestSafeGrass 和 findSafeGrassSpot 中引入前置物理距离过滤与剪枝，极大降低了僵持局中对 isSafe 几何射线的调用频次
 */
